$(".item-4").on("shown.bs.collapse",(function(){$("#lastHeader").css("border-bottom-left-radius","0px"),$("#lastHeader").css("border-bottom-right-radius","0px")})),$(".item-4").on("hidden.bs.collapse",(function(){$("#lastHeader").css("border-bottom-left-radius","10px"),$("#lastHeader").css("border-bottom-right-radius","10px")}));var desktopMenuPopup=document.getElementById("menu-desktop-popup");function animateModal(t){$(".modal .modal-dialog").attr("class","modal-dialog  "+t+"  animated")}desktopMenuPopup.addEventListener("click",(function(){"block"==$("#modalMenu").css("display")?document.getElementById("modalMenu").style.display="none":document.getElementById("modalMenu").style.display="block"}),!1),$("#modalFullScreen").on("show.bs.modal",(function(t){animateModal("fadeIn"),$("#modalFullScreen").css("z-index","2000")})),$("#modalFullScreen").on("hide.bs.modal",(function(t){animateModal("fadeOut")})),$("#modalSearch").on("show.bs.modal",(function(t){animateModal("fadeIn"),$("#modalFullScreen").css("z-index","2000")})),$("#modalSearch").on("hide.bs.modal",(function(t){animateModal("fadeOut")})),$("#modalProductCriteria").on("show.bs.modal",(function(t){animateModal("fadeIn"),$("#modalProductCriteria").css("z-index","2000")})),$("#modalProductCriteria").on("hide.bs.modal",(function(t){animateModal("fadeOut")})),$(window).on("load",(function(){jQuery("img.svg").each((function(){var t=jQuery(this),e=t.attr("id"),i=t.attr("class"),n=t.attr("src");jQuery.get(n,(function(n){var s=jQuery(n).find("svg");void 0!==e&&(s=s.attr("id",e)),void 0!==i&&(s=s.attr("class",i+" replaced-svg")),!(s=s.removeAttr("xmlns:a")).attr("viewBox")&&s.attr("height")&&s.attr("width")&&s.attr("viewBox","0 0 "+s.attr("height")+" "+s.attr("width")),t.replaceWith(s)}),"xml")}))})),
/*!
 ...
 */
function(t,e){"function"==typeof define&&define.amd?define(["flickity/js/index","imagesloaded/imagesloaded"],(function(i,n){return e(t,i,n)})):"object"==typeof module&&module.exports?module.exports=e(t,require("flickity"),require("imagesloaded")):t.Flickity=e(t,t.Flickity,t.imagesLoaded)}(window,(function(t,e,i){"use strict";e.createMethods.push("_createImagesLoaded");var n=e.prototype;return n._createImagesLoaded=function(){this.on("activate",this.imagesLoaded)},n.imagesLoaded=function(){if(this.options.imagesLoaded){var t=this;i(this.slider).on("progress",(function(e,i){var n=t.getParentCell(i.img);t.cellSizeChange(n&&n.element),t.options.freeScroll||t.positionSliderAtSelected()}))}},e})),$("#promotedProducts").on({mouseenter:function(){$("#promotedProducts .flickity-prev-next-button").fadeIn("slow",(function(){$("#promotedProducts .flickity-prev-next-button").css("display","block")}))},mouseleave:function(){$("#promotedProducts .flickity-prev-next-button").fadeOut("slow",(function(){}))}}),$("#reccomendedProducts").on({mouseenter:function(){$("#reccomendedProducts .flickity-prev-next-button").fadeIn("slow",(function(){$("#reccomendedProducts .flickity-prev-next-button").css("display","block")}))},mouseleave:function(){$("#reccomendedProducts .flickity-prev-next-button").fadeOut("slow",(function(){}))}}),$("#relatedProducts").on({mouseenter:function(){$("#relatedProducts .flickity-prev-next-button").fadeIn("slow",(function(){$("#relatedProducts .flickity-prev-next-button").css("display","block")}))},mouseleave:function(){$("#relatedProducts .flickity-prev-next-button").fadeOut("slow",(function(){}))}});